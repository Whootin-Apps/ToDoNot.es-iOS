...
-(void)setType:(MKInfoPanelType)type {
    if(type == MKInfoPanelTypeError) {
        self.backgroundGradient.image = [[UIImage imageNamed:@"Red1"] stretchableImageWithLeftCapWidth:1 topCapHeight:5];
        ...
        self.backgroundGradient.image = [[UIImage imageNamed:@"Blue1"] stretchableImageWithLeftCapWidth:1 topCapHeight:5];
