...
- (void)makeToastActivity:(id)position {
    ...
    [activityContainer setBackgroundColor:[[UIColor cyanColor] colorWithAlphaComponent:kOpacity]];
    ...
    if (kDisplayShadow) {
        [activityContainer.layer setShadowColor:[UIColor cyanColor].CGColor];
...
- (UIView *)makeViewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    [wrapperView setBackgroundColor:[UIColorFromRGB(0x39BDEC) colorWithAlphaComponent:kOpacity]];
